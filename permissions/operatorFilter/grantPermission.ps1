...
try {
    ...
    if (-Not($actionContext.DryRun -eq $true)) {          
        ...
        Write-Verbose "Granting operator filter $($actionContext.PermissionDisplayName) ($($actionContext.References.Permission.Reference)) to $($actionContext.References.Account)"
        $splatParams = @{
        ...
        Write-Verbose "Successfully granted operator filter $($actionContext.PermissionDisplayName) ($($actionContext.References.Permission.Reference)) to $($actionContext.References.Account)"
