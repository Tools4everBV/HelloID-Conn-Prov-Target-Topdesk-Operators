...
try {
    ...
    if (-Not($actionContext.DryRun -eq $true)) {          
        ...
        Write-Verbose "Granting operator group $($actionContext.PermissionDisplayName) ($($actionContext.References.Permission.Reference)) to $($actionContext.References.Account)"
        $splatParams = @{
        ...
        Write-Verbose "Successfully granted operator group $($actionContext.PermissionDisplayName) ($($actionContext.References.Permission.Reference)) to $($actionContext.References.Account)"
