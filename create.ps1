...
#correlation attribute. Is used to lookup the user in the Get-TopdeskOperatorByCorrelationAttribute function. Not migrated to settings because it's only used in the user create script.
